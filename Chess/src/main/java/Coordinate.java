...
public class Coordinate {
  ...
  public static Coordinate from(String coordinateString) {
    return new Coordinate(coordinateString.substring(0, 1), Integer.parseInt(coordinateString.substring(1,2)));
  }
